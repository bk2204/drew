...
int gnutls_pubkey_import_openpgp(gnutls_pubkey_t pkey, gnutls_openpgp_crt_t crt, unsigned int flags);
...
int gnutls_pubkey_import_pkcs11_url(gnutls_pubkey_t key, const char *url, unsigned int flags);
...
int gnutls_pubkey_get_verify_algorithm(gnutls_pubkey_t key, const gnutls_datum_t *signature, gnutls_digest_algorithm_t *hash);
...
int gnutls_privkey_get_preferred_hash_algorithm(gnutls_privkey_t key, gnutls_digest_algorithm_t *hash, unsigned int *mand);
