...
extern "C" {
PLUGIN_STRUCTURE(sha256, SHA256)
PLUGIN_STRUCTURE(sha224, SHA224)
PLUGIN_DATA_START()
...
static int sha256test(void *, const drew_loader_t *)
{
	int res = 0;
...
static int sha224test(void *, const drew_loader_t *)
{
	int res = 0;
