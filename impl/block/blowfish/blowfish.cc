...
static bool bftest(const char *key, const char *plain, const char *cipher,
		size_t keybytes = 0)
{
	using namespace drew;

	uint8_t kb[24], pb[8], cb[8], buf[8];
...
static int blowfish_samekey(void)
{
	int res = 0;
	const char *k = "F0E1D2C3B4A5968778695A4B3C2D1E0F0011223344556677";
	const char *d = "FEDCBA9876543210";

	res |= !bftest(k, d, "BE1E639408640F05",  4);
	res |= !bftest(k, d, "B39E44481BDB1E6E",  5);
	res |= !bftest(k, d, "9457AA83B1928C0D",  6);
	res |= !bftest(k, d, "8BB77032F960629D",  7);
	res |= !bftest(k, d, "E87A244E2CC85E82",  8);
	res |= !bftest(k, d, "15750E7A4F4EC577",  9);
	res |= !bftest(k, d, "122BA70B3AB64AE0", 10);
	res |= !bftest(k, d, "3A833C9AFFC537F6", 11);
	res |= !bftest(k, d, "9409DA87A90F6BF2", 12);
	res |= !bftest(k, d, "884F80625060B8B4", 13);
	res |= !bftest(k, d, "1F85031C19E11968", 14);
	res |= !bftest(k, d, "79D9373A714CA34F", 15);
	res |= !bftest(k, d, "93142887EE3BE15C", 16);
	res |= !bftest(k, d, "03429E838CE2D14B", 17);
	res |= !bftest(k, d, "A4299E27469FF67B", 18);
	res |= !bftest(k, d, "AFD5AED1C1BC96A8", 19);
	res |= !bftest(k, d, "10851C0E3858DA9F", 20);
	res |= !bftest(k, d, "E6F51ED79B9DB21F", 21);
	res |= !bftest(k, d, "64A6E14AFD36B46F", 22);
	res |= !bftest(k, d, "80C7D7D45A5479AD", 23);
	res |= !bftest(k, d, "05044B62FA52D080", 24);
...
static int blowfishtest(void *, const drew_loader_t *)
{
	...
	res |= !bftest("0000000000000000", "0000000000000000", "4EF997456198DD78");
	res |= !bftest("FFFFFFFFFFFFFFFF", "FFFFFFFFFFFFFFFF", "51866FD5B85ECB8A");
	res |= !bftest("3000000000000000", "1000000000000001", "7D856F9A613063F2");
	res |= !bftest("1111111111111111", "1111111111111111", "2466DD878B963C9D");
	res |= !bftest("0123456789ABCDEF", "1111111111111111", "61F9C3802281B096");
	res |= !bftest("1111111111111111", "0123456789ABCDEF", "7D0CC630AFDA1EC7");
	res |= !bftest("0000000000000000", "0000000000000000", "4EF997456198DD78");
	res |= !bftest("FEDCBA9876543210", "0123456789ABCDEF", "0ACEAB0FC6A0A28D");
	res |= !bftest("7CA110454A1A6E57", "01A1D6D039776742", "59C68245EB05282B");
	res |= !bftest("0131D9619DC1376E", "5CD54CA83DEF57DA", "B1B8CC0B250F09A0");
	res |= !bftest("07A1133E4A0B2686", "0248D43806F67172", "1730E5778BEA1DA4");
	res |= !bftest("3849674C2602319E", "51454B582DDF440A", "A25E7856CF2651EB");
	res |= !bftest("04B915BA43FEB5B6", "42FD443059577FA2", "353882B109CE8F1A");
	res |= !bftest("0113B970FD34F2CE", "059B5E0851CF143A", "48F4D0884C379918");
	res |= !bftest("0170F175468FB5E6", "0756D8E0774761D2", "432193B78951FC98");
	res |= !bftest("43297FAD38E373FE", "762514B829BF486A", "13F04154D69D1AE5");
	res |= !bftest("07A7137045DA2A16", "3BDD119049372802", "2EEDDA93FFD39C79");
	res |= !bftest("04689104C2FD3B2F", "26955F6835AF609A", "D887E0393C2DA6E3");
	res |= !bftest("37D06BB516CB7546", "164D5E404F275232", "5F99D04F5B163969");
	res |= !bftest("1F08260D1AC2465E", "6B056E18759F5CCA", "4A057A3B24D3977B");
	res |= !bftest("584023641ABA6176", "004BD6EF09176062", "452031C1E4FADA8E");
	res |= !bftest("025816164629B007", "480D39006EE762F2", "7555AE39F59B87BD");
	res |= !bftest("49793EBC79B3258F", "437540C8698F3CFA", "53C55F9CB49FC019");
	res |= !bftest("4FB05E1515AB73A7", "072D43A077075292", "7A8E7BFA937E89A3");
	res |= !bftest("49E95D6D4CA229BF", "02FE55778117F12A", "CF9C5D7A4986ADB5");
	res |= !bftest("018310DC409B26D6", "1D9D5C5018F728C2", "D1ABB290658BC778");
	res |= !bftest("1C587F1C13924FEF", "305532286D6F295A", "55CB3774D13EF201");
	res |= !bftest("0101010101010101", "0123456789ABCDEF", "FA34EC4847B268B2");
	res |= !bftest("1F1F1F1F0E0E0E0E", "0123456789ABCDEF", "A790795108EA3CAE");
	res |= !bftest("E0FEE0FEF1FEF1FE", "0123456789ABCDEF", "C39E072D9FAC631D");
	res |= !bftest("0000000000000000", "FFFFFFFFFFFFFFFF", "014933E0CDAFF6E4");
	res |= !bftest("FFFFFFFFFFFFFFFF", "0000000000000000", "F21E9A77B71C49BC");
	res |= !bftest("0123456789ABCDEF", "0000000000000000", "245946885754369A");
	res |= !bftest("FEDCBA9876543210", "FFFFFFFFFFFFFFFF", "6B5C5A9C5D9E0A5A");
	res <<= 1;

	res |= blowfish_samekey();
...
const uint32_t drew::Blowfish::m_parray[] = {
